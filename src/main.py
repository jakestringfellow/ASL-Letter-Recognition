...
'''
    preprocessImage
    Performs preprocessing on input image (live video stream frame) in order to more closely resemble
    the data in the Sign-MNIST dataset.
    Parms: 
        roi - a cropped image portion of the live video frame where sign recognition takes place
    Returns:
        None
'''
